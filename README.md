...
The script fetches recent MCF listings, applies the 14-day heuristic, and sends suspicious postings for LLM review.
...
- `scraper.py` — fetches job data and runs the ghost-job heuristic + LLM analysis
